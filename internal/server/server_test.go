...
func TestServer(t *testing.T) {
	...
	tableTest := []struct {
		...
		},
		{
			...
			`{"first_name":"jhon","last_name":"connor","age":"30","email":"jconnor@gmail.com","store_id":"2"}`,
			`{"id":"1"}`,
			http.StatusOK,
		},
		{
			...
			``,
			`{"id":"1","first_name":"jhon","last_name":"connor","age":"30","email":"jconnor@gmail.com","store_id":"2"}`,
			http.StatusOK,
		},
		{
			...
			http.MethodPut,
			srv.URL + "/api/customers/1",
			`{"id":"1","first_name":"mick","last_name":"addams","age":"20","email":"maddams@gmail.com","store_id":"2"}`,
			``,
			http.StatusOK,
		},
		{
			...
			srv.URL + "/api/customers",
			``,
			`{"customers":[{"id":"1","first_name":"mick","last_name":"addams","age":"20","email":"maddams@gmail.com","store_id":"2"}]}`,
			http.StatusOK,
		},
		{
		...
		},
		{
			...
			http.MethodPost,
			srv.URL + "/api/customers",
			`{"id":"2","first_name":"jhon","last_name":"connor","age":"30","email":"jconnor@gmail.com","store_id":"2"}`,
			`{"id":"2"}`,
			http.StatusOK,
		},
		{
